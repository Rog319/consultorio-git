      ...
      <AuthContextProvider>
        ...
        <div className={styles.contenido}>
          ...
          <p className={styles.parrafo}>
            ...
            <br /> <br />
            La distribución puede ser elaborada en base a porcentajes estándares
            establecidos o a un cálculo de gramos de macronutrientes
            considerando el peso actual del paciente.
            <br /> <br />
            Los porcentajes normales ó estándar para adulto promedio son
            hidratos de carbono (55-65%), proteínas (10-15%) y lípidos (25-30%)
            de las kcal estimadas para ese paciente.
            <br />
            <br />
            Los gramos normales o estándar dependerán del peso del paciente, el
            cálculo de los gramos de proteínas en la dieta es el de mayor
            relevancia ya que en diversas condiciones tanto patológicas como de
            mejora de composición corporal es muy utilizado; la recomendación en
            adultos normopeso y con condiciones óptimas de salud es de 0.8 a 1
            gramos de proteína por kilogramo peso corporal al día.
          </p>
        </div>
      </AuthContextProvider>
    );
